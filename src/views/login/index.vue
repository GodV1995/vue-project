  ...
  <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
    <div class="login_wrap">
      <div class="login_top">
        <div class="wrapper">
            <div class="login_sysname">
              <span class="login_logo"><img class="logoimg" src="@/assets/logins/blank.png"></span><h1>合肥信息技术服务有限公司</h1>
            </div>
        </div>
      </div>
      ...
      <div class="login_footer">
        <div class="wrapper">
          <div class="footer_text">版权所有：合肥信息技术服务有限公司  技术支持：合肥信息技术服务有限公司  客服热线：400-6655-990</div>
        </div>
      </div>
    </div>
...
import { goLogin, getMenu } from '@/api/user'
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          // goLogin(this.loginForm).then((data) => {
          //   console.log(data)
          ...
          //   getMenu().then((data) => {
          //     console.log(data)
          //     localStorage.setItem('getRouter', JSON.stringify(data.data.menus))
          //   }).catch(() => {
          //     console.log('失败')
          //   })
          // })
